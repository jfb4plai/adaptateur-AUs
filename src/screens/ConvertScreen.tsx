...
const STEPS: Omit<ConversionStep, 'status'>[] = [
  ...
  { id: 'transcribe',    label: 'Transcription fidèle (passe 1 — PDF uniquement)' },
  { id: 'claude',        label: 'Adaptation AU (passe 2)' },
  { id: 'arasaac',       label: 'Pictogrammes Arasaac (texte + illustrations)' },
